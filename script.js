let inProgress = document.getElementsByClassName('glide__slide');
//auto-lists code revision
//let inProgress = document.getElementsByClassName('glide__slides')[0];
...
function createElement(incomingJSON){
  //attempt at creating lists in Json, overrides width and white-space
  // let newList = document.createElement("li");
  // newList.classList.add("itemList");

  let newElement = document.createElement("div");
  newElement.classList.add("contentItem");
  if(incomingJSON['completion']==100){
    newElement.style.backgroundColor = "rgba(198, 191, 245,.8)";
  }else if(incomingJSON['completion'] < 25){
    newElement.style.backgroundColor = "rgba(240, 141, 141,.8)";
  }else{
    newElement.style.backgroundColor = "rgba(245, 191, 243,.8)";
  }
  ...
  inProgress[i].appendChild(newElement);
  //with lists
  //inProgress.appendChild(newElement);
}
